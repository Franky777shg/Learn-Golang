...
// 	// Use ... for free length of array and must declare the content of the array
// 	// months := [...]string{
// 	// 	"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec",
// 	// }

// 	// Slice, make array from existing array
...
// 	// fmt.Println(len(newSlicePrintln()
...
// 	// Break and Continue same with javascript
// }
